                                    ...
                                    <div class="carousel-inner">
                                        @foreach($page->media as $media)
                                            <div class="carousel-item {{$loop->index}}" class="{{$loop->index == 0 ? 'active' : ''}}">
                                                <img class="d-block w-100" src="{{asset('assets/posts/'.$media->filename)}}" alt="{{$page->title}}">
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="post_header">
                                    ...
                                    <div class="blog-date-categori">
                                        <ul>
                                            ...
                                            <li><span>Author : </span><a href="#" title="Posts by {{$page->user->name}}" rel="author">{{$page->user->name}}</a></li>
                                        </ul>
                                    </div>
                                </div>
